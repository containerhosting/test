...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-at8oym0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-at8oym0.containers.anotherwebservice.com/
...
```
git clone git@github.com:containerhosting/test.git
cd container-at8oym0
```
...
```
docker attach container-at8oym0
```
